...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Mengubah data</a>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Pemesinan" <?php if ($siswa['jurusan'] == 'Pemesinan') { ?> selected='' <?php } ?>>Pemesinan</option>
                            <option value="Teknik Pembuatan Kain" <?php if ($siswa['jurusan'] == 'Teknik Pembuatan Kain') { ?> selected='' <?php } ?>>Teknik Pembuatan Kain</option>
                            <option value="Ototronik" <?php if ($siswa['jurusan'] == 'Ototronik') { ?> selected='' <?php } ?>>Ototronik</option>
                            <option value="Pengembangan Perangkat Lunak dan Gim" <?php if ($siswa['jurusan'] == 'Pengembangan Perangkat Lunak dan Gim') { ?> selected='' <?php } ?>>Pengembangan Perangkat Lunak dan Gim</option>
                        </select>
                    </div>
                    <div class="mb-3">
