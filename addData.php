...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Menambahkan data</a>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://www.instagram.com/ikhsansetyo05/?next=%2F" target="_blank" style="color: #fff;">ikhsansetyo05</a></p>
    </footer>
    <!-- Close Footer -->
